...
<form class="forms-sample" action="<?php echo e(route('complaintsModule.update')); ?>" method="post" enctype="multipart/form-data">
<?php echo e(csrf_field()); ?>


<input type="hidden" name="complaint_id" value="<?php echo e($complaints->id); ?>">
...
<div class="col-md-6 grid-margin stretch-card">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="contact_number" name="contact_number" value="<?php echo e($complaints->contact_number); ?>" autocomplete="off" placeholder="Contact Number">
    </div>

     <div class="form-group">
        <label class="control-label">Full Name</label>
        <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo e($complaints->full_name); ?>" autocomplete="off" placeholder="Full Name">
    </div>

   <div class="form-check form-check-flat form-check-primary">
                                        <label class="form-check-label">
                                            <input type="checkbox" name="keep_identity_concealed" value="1" class="form-check-input" <?php echo e(($complaints->keep_identity_concealed == "1") ? 'checked': ''); ?>>
     ...
     <option selected="" disabled="">Select Village</option>
            ...
            <?php if($complaints->villege == $village->villege): ?>
                <option value="<?php echo e($village->id); ?>" selected="selected"><?php echo e($village->villege); ?></option>
                <?php else: ?> 
                <option value="<?php echo e($village->id); ?>"><?php echo e($village->villege); ?></option>
                <?php endif; ?>
...
<select class="js-example-basic-single w-100" name="beat">
     <option selected="" disabled="">Select Beat</option>
            ...
            <?php if($complaints->beat == $forestarea->beat): ?>
     ...
     <div class="form-group">
        <label class="control-label">Block</label>
          ...
          <input type="text" class="form-control" id="block" name="block" value="<?php echo e($complaints->block); ?>" autocomplete="off" placeholder="Block">
    </div>

     <div class="form-group">
        <label class="control-label">Range</label>
       
         <input type="text" class="form-control" id="range" name="range" value="<?php echo e($complaints->range); ?>" autocomplete="off" placeholder="Range">
    </div>


      <div class="form-group">
        <label class="control-label">District</label>
        <input type="text" class="form-control" id="district" name="district" value="<?php echo e($complaints->district); ?>" autocomplete="off" placeholder="District">
    </div>

     <div class="form-group">
        <label class="control-label">Division</label>
       
        <input type="text" class="form-control" id="division" name="division" value="<?php echo e($complaints->division); ?>" autocomplete="off" placeholder="Division">
    </div>
     ...
     <div class="form-group">
        ...
        <select class="form-control" name="complaint" id="complaint">
            ...
            <?php if($complaints->complaint == $complainttype->complaint_type): ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       ...
                                       <textarea class="form-control" name="information" id="information" rows="5"><?php echo e($complaints->information); ?></textarea>
 ...
 <label class="control-label">Complaint Detail</label>
                                       <textarea class="form-control" name="complaintdetail" id="complaintdetail" rows="5"><?php echo e($complaints->complaintdetail); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/databoxstudio/public_html/complaintportal/resources/views/ComplaintModule/edit.blade.php ENDPATH**/ ?>