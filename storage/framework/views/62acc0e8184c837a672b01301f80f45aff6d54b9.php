...
<td><?php echo e($complaint->contact_number); ?> </td>
                        ...
                        <td><a href="<?php echo e(route('complaintsModule.view',$complaint->id)); ?>" class="view_client" ids="<?php echo e($complaint->id); ?>"><i class="icon-sm mr-2" data-feather="eye"></i></a> | <a href="<?php echo e(route('complaintsModule.edit',$complaint->id)); ?>"><i data-feather="edit-3" class="icon-sm mr-2"></i></a> | <a href="<?php echo e(route('complaintsModule.delete',$complaint->id)); ?>" onclick="return confirm('Are you sure?')"><i data-feather="trash" class="icon-sm mr-2"></i></i></a></td> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\complaint-manager\resources\views/ComplaintModule/index.blade.php ENDPATH**/ ?>