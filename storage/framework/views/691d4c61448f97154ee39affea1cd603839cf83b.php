         ...
         <?php if(!empty($complaint->complaint)): ?>
          ...
          Complaint: <?php echo e($complaint->complaint); ?> <br/><br/>
           ...
           <?php endif; ?>
                        ...
                        <td><a href="<?php echo e(route('complaintsModule.view',$complaint->id)); ?>" class="view_client" ids="<?php echo e($complaint->id); ?>"><img src="/public/assets/images/icons8-view-25.png" style="width:14px;"></a>|<a href="<?php echo e(route('complaintsModule.edit',$complaint->id)); ?>"><img src="/public/assets/images/icons8-edit-24.png" style="width:14px;"></a>|<a href="<?php echo e(route('complaintsModule.delete',$complaint->id)); ?>" onclick="return confirm('Are you sure?')"><img src="/public/assets/images/icons8-delete.svg" style="width:14px;"></a></td>
                      </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/databoxstudio/public_html/resources/views/ComplaintModule/index.blade.php ENDPATH**/ ?>