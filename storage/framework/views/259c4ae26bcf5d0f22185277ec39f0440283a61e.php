                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="dob"  name="dob" autocomplete="off" placeholder="Date of Birth" value="<?php echo e($users->dob); ?>" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy">
                                                </div>
                                            </div><!-- Col -->
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label">City</label>
                                                       <input type="text" class="form-control" id="permanent_address_city"  name="permanent_address_city" autocomplete="off" placeholder="City" value="<?php echo e($users->permanent_address_city); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\complaint-manager\resources\views/userModule/editprofile.blade.php ENDPATH**/ ?>