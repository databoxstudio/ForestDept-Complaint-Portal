...
<select class="js-example-basic-single w-100" name="beat" id="beatdrop">
 ...
 <label class="control-label">Complaint Detail</label>
                                       <textarea class="form-control" name="complaintdetail" id="complaintdetail" rows="5"><?php echo e(old('complaintdetail')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/databoxstudio/public_html/complaintportal/resources/views/ComplaintModule/create.blade.php ENDPATH**/ ?>