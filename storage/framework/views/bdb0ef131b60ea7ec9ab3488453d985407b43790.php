...
<?php if(isset(Auth::user()->role) && Auth::user()->role == 'admin' ): ?>
          ...
          <?php endif; ?>
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('complaintsModule.contactnumbers')); ?>" role="button" aria-expanded="false" aria-controls="advancedUI">
              <i class="link-icon" data-feather="feather"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#advancedUI" role="button" aria-expanded="false" aria-controls="advancedUI">
             ...
             <div class="collapse1" id="advancedUI">
              <ul class="nav sub-menu">
              <li class="nav-item">
                  <a href="<?php echo e(route('complaintsModule.complaints')); ?>" class="nav-link">Complaints</a>
                </li>
    <li class="nav-item">
                  <a href="<?php echo e(route('complaintsModule.create')); ?>" class="nav-link">Add Complaint</a>
                </li>
              </ul>
            </div> 
          </li>
    ...
    </nav><?php /**PATH /home/databoxstudio/public_html/complaintportal/resources/views/layouts/partials/_sidebar.blade.php ENDPATH**/ ?>